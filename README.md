...
# 📖 Blog_API <a name="about-project"></a>

**Blog_API** is web app to display user comments and post, It allows for new users to join the blog, post a comment and can also comment on post from other users.
